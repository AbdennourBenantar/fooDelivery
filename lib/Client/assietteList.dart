...
class AssietteList extends StatefulWidget with NavStates {
  @override
  _AssietteListState createState() => _AssietteListState();
}

class _AssietteListState extends State<AssietteList> {
  @override
