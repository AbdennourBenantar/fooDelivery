...
class SandList extends StatefulWidget with NavStates {
  @override
  _SandListState createState() => _SandListState();
}

class _SandListState extends State<SandList> {
  @override
